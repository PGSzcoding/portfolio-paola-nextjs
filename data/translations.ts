...
export const translations = {
  es: {
    ...
    about: {
      ...
      title: {
        first: 'Diseño con intención.',
        second: 'Programo con propósito.',
      },
...
aiTwin: {
  ...
  description:
    'A digital version of me, ready to answer questions about my experience, projects, and technology.',
...
footer: {
  message:
    'Je crée des expériences digitales avec du code et de la créativité.',
